...
public class NaturalNumberTupleTest {
    ...
    public void testEqualsNaturalNumberTuple() {
        ...
        testObject = new TestObject(testnumbers);
        result = testObject.run("equals", new TestObject(testnumbers));
        assertEquals(
                standardMessage("equals(new NaturalNumberTuple(new int[]" + NumbersToString(testnumbers) + ")",
                        testnumbers), true, result);
        result = testObject.run("equals", new TestObject(testnumbers2));
        assertEquals(
    ...
    public void testSwap() {
        ...
        testObject = new TestObject(testnumbers);
        testObject.run("swap", new Object[] {2000, -20});
        result = testObject.run("indexOf", 1);
        ...
        testObject = new TestObject(testnumbers);
        testObject.run("swap", new Object[] {2, 3});
        result = testObject.run("indexOf", 1);
    ...
    public void testToSet() {
        ...
        result1 = testObject.run("toSet");
        result2 = testObject.run("equals", result1);
