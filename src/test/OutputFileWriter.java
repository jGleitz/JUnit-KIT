...
public class OutputFileWriter {
	...
	private static String[] head() {
		return new String[] {
				...
				"				font-style: normal;",
				"				font-weight: 300;",
				"				src: url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-L.ttf) format('truetype');",
				"			}",
				"			",
				"			@font-face {",
				"				font-family: 'Ubuntu';",
				"				font-style: normal;",
				"				font-weight: 400;",
				"				src: url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-R.ttf) format('truetype');",
				"			}",
				"			",
				"			@font-face {",
				"				font-family: 'Ubuntu';",
				"				font-style: normal;",
				"				font-weight: 700;",
				"				src: url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-B.ttf) format('truetype');",
				"			}",
				"			",
				"			@font-face {",
				"				font-family: 'Ubuntu';",
				"				font-style: italic;",
				"				font-weight: 400;",
				"				src: url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-RI.ttf) format('truetype');",
				"			}",
				"			",
				"			@font-face {",
				...
				"				font-style: normal;",
				"				font-weight: 400;",
				"				src: url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-C.ttf) format('truetype');",
				"			}",
				"			",
				"			@font-face {",
				...
				"				font-style: normal;",
				"				font-weight: 400;",
				"				src: url(http://files.joshuagleitze.de/ubuntu-font-family/UbuntuMono-R.ttf) format('truetype');",
				"			}",
				"			",
				"			* {",
