...
public class OutputFileWriter {
        ...
        if (writeOutputFile) {
            ...
            try {
                ...
                for (String testClass : CONTENT_MAP.keySet()) {
                    ...
                    write(new String[] {
                            "<div class=\"testClass\">", "<h3>" + testClass + "</h3>"
                    }, outputWriter);
                    ...
                    for (TestMethod testMethod : classMap.values()) {
                        ...
                        write(new String[] {
                                ...
                                "<h4 onclick=\"toggleMethod(" + id + ");\"><span class=\"opener\">⏵</span>"
                                        + testMethod.name + indicator + "</h4>", "<div class=\"sessions\">"
                        }, outputWriter);
    ...
    private static String[] head() {
        return new String[] {
                ...
                "               <link href=\"http://fonts.googleapis.com/css?family=Ubuntu:400,300|Ubuntu+Mono|Ubuntu+Condensed\" rel=\"stylesheet\" type=\"text/css\">",
                "               <style>",
                "                       * {",
    ...
    private class OutputRunListener extends RunListener {
        ...
        public void testFailure(Failure failure) throws Exception {
            ...
            getMethod(className, methodName).success = false;
        }
