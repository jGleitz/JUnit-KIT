...
public class OutputFileWriter {
	...
	private static String[] head() {
		return new String[] {
				...
				"				font-style: normal;",
				"				font-weight: 300;",
				"				src: local('Ubuntu Light'), local('Ubuntu-Light'), url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-L.ttf) format('ttf');",
				"			}",
				"			",
				"			@font-face {",
				"				font-family: 'Ubuntu';",
				"				font-style: normal;",
				"				font-weight: 400;",
				"				src: local('Ubuntu'), , url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-R.ttf) format('ttf');",
				"			}",
				"			",
				"			@font-face {",
				"				font-family: 'Ubuntu';",
				"				font-style: normal;",
				"				font-weight: 700;",
				"				src: local('Ubuntu Bold'), local('Ubuntu-Bold'), url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-B.ttf) format('ttf');",
				"			}",
				"			",
				"			@font-face {",
				"				font-family: 'Ubuntu';",
				"				font-style: italic;",
				"				font-weight: 400;",
				"				src: local('Ubuntu Italic'), local('Ubuntu-Italic'), url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-I.ttf) format('ttf');",
				"			}",
				"			",
				"			@font-face {",
				...
				"				font-style: normal;",
				"				font-weight: 400;",
				"				src: local('Ubuntu Condensed'), local('UbuntuCondensed-Regular'), url(http://files.joshuagleitze.de/ubuntu-font-family/Ubuntu-C.ttf) format('ttf');",
				"			}",
				"			",
				"			@font-face {",
				...
				"				font-style: normal;",
				"				font-weight: 400;",
				"				src: local('Ubuntu Mono'), local('UbuntuMono-Regular'), url(http://files.joshuagleitze.de/ubuntu-font-family/UbuntuMono-R.ttf) format('ttf');",
				"			}",
				"			",
				"			* {",
