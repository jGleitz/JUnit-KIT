...
public class BooksInteractiveConsoleTest extends InteractiveConsoleTest {
    ...
    public void infoWithPreOrder1() {
        oneLineTest("info\nquit\n", "word1:1", BOOK_6_1.getAbsolutePath());
    }
    ...
    public void infoWithPreOrder2() {
        oneLineTest("info\nquit\n", "word1:1,2", BOOK_6_2.getAbsolutePath());
    }
    ...
    public void infoWithPreOrder3() {
        oneLineTest("info\nquit\n", "b:1,2,a:1,3,aa:3,c:1,d:2,ca:3,e:3", BOOK_7.getAbsolutePath());
    }

    @Test
    public void infoWithInOrder3() {
        oneLineTest("info\nquit\n", "a:1,3,aa:3,b:1,2,c:1,ca:3,d:2,e:3", BOOK_7.getAbsolutePath());
    }
